...
# Пример работы с файлом. Если у нас есть JSON-файл, мы можем загрузить его в Pydantic-модель так:
import json

with open("account.json", "r") as file:
    account_data = file.read()

account_model = AccountSchema.model_validate_json(account_data)
print(account_model)


# Инициализируем DocumentSchema c некорректным url
try:
