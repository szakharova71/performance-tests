...
print("Create debit card account response:", open_debit_card_account_response_data)
print("Create debit card account status code:", open_debit_card_account_response.status_code)
...
print("Create virtual card response:", issue_virtual_card_response_data)
print("Create virtual card status code:", issue_virtual_card_response.status_code)